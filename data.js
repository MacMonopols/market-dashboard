...
const MARKETS = [
  ...
  },
  {
    ...
    subMarkets: [
      ...
      { name: "Alphabet",  ticker: "GOOGL", flag: "🔍", weight: 14.29, note: "Alphabet Inc. (Class A)" },
      { name: "Amazon",    ticker: "AMZN",  flag: "📦", weight: 14.29, note: "Amazon.com Inc." },
      { name: "Nvidia",    ticker: "NVDA",  flag: "🎮", weight: 14.29, note: "Nvidia Corp." },
      { name: "Meta",      ticker: "META",  flag: "📘", weight: 14.29, note: "Meta Platforms Inc." },
