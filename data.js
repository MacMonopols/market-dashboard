...
const MARKETS = [
  // ── Aktien ───────────────────────────────────────────────────────────────
  {
    ...
    // Country breakdown (Weights: BGF Emerging Markets Fund factsheet, May 2026)
    subMarketsWeightDate: "May 2026",
    subMarkets: [
      { name: "Taiwan",       ticker: "EWT",  flag: "🇹🇼", weight: 26.52, note: "iShares MSCI Taiwan ETF"        },
      { name: "Korea",        ticker: "EWY",  flag: "🇰🇷", weight: 23.17, note: "iShares MSCI South Korea ETF"   },
      { name: "China",        ticker: "MCHI", flag: "🇨🇳", weight: 20.16, note: "iShares MSCI China ETF"         },
      { name: "India",        ticker: "INDA", flag: "🇮🇳", weight: 10.73, note: "iShares MSCI India ETF"         },
      { name: "South Africa", ticker: "EZA",  flag: "🇿🇦", weight:  3.05, note: "iShares MSCI South Africa ETF"  },
      { name: "Brazil",       ticker: "EWZ",  flag: "🇧🇷", weight:  2.43, note: "iShares MSCI Brazil ETF"        },
      { name: "Saudi Arabia", ticker: "KSA",  flag: "🇸🇦", weight:  1.84, note: "iShares MSCI Saudi Arabia ETF"  },
      { name: "Mexico",       ticker: "EWW",  flag: "🇲🇽", weight:  1.67, note: "iShares MSCI Mexico ETF"        },
      { name: "Germany",      ticker: null,   flag: "🇩🇪", weight:  1.41, note: "EM-listed German companies"     },
